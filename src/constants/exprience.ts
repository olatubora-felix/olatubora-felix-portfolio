export const experiences: Exprience[] = [
  {
    ...
    description: [
      "Successfully delivered application development for Afrinvestor, the official digital investment platform of Afrinvest, serving 700,000+ active users across mobile and web platforms while maintaining 99.9% uptime and high transaction reliability.",
      ...
      "Developed and integrated secure RESTful APIs with backend services, ensuring reliable communication between frontend applications and core business systems.",
      "Optimized backend API performance through efficient database queries, pagination, request validation, and response caching, improving overall system responsiveness and scalability.",
      "Collaborated with backend engineers to design scalable API contracts, implement authentication and authorization, and ensure secure handling of financial transactions and user data.",
      "Built and maintained backend services using NestJS and PostgreSQL, implementing modular architecture, robust error handling, and comprehensive input validation to improve maintainability and system reliability.",
      "Participated in backend architecture discussions, code reviews, and deployment processes, contributing to high availability, production stability, and seamless feature releases.",
    ],
  },
  {
    title: "Senior Software Engineer",
