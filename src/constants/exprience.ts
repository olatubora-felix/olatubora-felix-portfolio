export const experiences: Exprience[] = [
  {
    ...
    description: [
      ...
      "Designed and implemented PHP/Laravel backend services and microservice-based APIs powering core investment flows, ensuring secure transaction processing and integration with internal and third-party systems.",
      ...
      "Implemented advanced caching mechanisms using server components and backend-side optimizations, reducing API calls by 40% and improving average page load time from 3.2s to 1.8s.",
      ...
      "Contributed to CI/CD pipelines for backend and web services and DevOps infrastructure (environment configuration, logging, monitoring, and deployments), improving release reliability and shortening deployment cycles.",
  ...
  },
  {
    ...
    logo: "/myvamsnet.svg",
    description: [
      "Led the engineering team in designing and implementing scalable backend services and RESTful APIs using PHP/Laravel, NestJS, PostgreSQL, Drizzle ORM, and TypeORM.",
      "Designed database schemas, optimized complex queries, and implemented indexing strategies to improve backend performance and reliability.",
      "Built secure authentication and authorization flows, enforcing robust access control and data protection across all services.",
      "Owned deployment workflows for backend services using AWS,and automated CI/CD pipelines, coordinating efforts across the team.",
      "Implemented logging, monitoring, and alerting to improve system observability and reduce mean time to resolution (MTTR) for production issues.",
      "Collaborated with frontend and product teams and built the client mobile app using React Native and Expo, translating business requirements into scalable backend architectures, mobile-ready APIs, and iterative releases.",
    ],
  },
  {
    title: "Senior Software Engineer",
